...
async function loadDashboard() {
    ...
    try {
        ...
        document.getElementById('totalPredictions').textContent = totalPredictions || 0;
...
Ghi chú: ${result.note || 'Không có'}
        ...
        predSnap.forEach(doc => {
            const data = doc.data();
            if (data.isCorrect) correctPredictions++;
